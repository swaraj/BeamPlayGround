...
public class BeamPipelineDisruptor {
    ...
    public static void main(String[] args) {
        ReplacerService.start();

        Runtime.getRuntime().addShutdownHook(new Thread(ReplacerService::shutdown));
    ...
    private static class BatchAggregateDoFn extends DoFn<KV<String, String>, KV<String, Integer>> {
        ...
        public void process(
            ...
            endOfTimeTimer.set(org.joda.time.Instant.now().plus(org.joda.time.Duration.standardMinutes(10)));
        ...
        private void flushOutput(
            ...
            for (String key : distinctElements.keySet()) {
                ...
                KV<String, Integer> kv = KV.of(ReplacerService.getReplacement(key), timestampsAndWindows.size());
